...
const editorRef =
useRef(null);
    // If the slides were generated by AI, we allow them to be edited in the IDE.
...
Use AIRDeck Sandbox for JavaScript support.`
      );
    }

if (attempts > 3) {
    alert(
      "Too many attempts. Removing JavaScript."
    );
